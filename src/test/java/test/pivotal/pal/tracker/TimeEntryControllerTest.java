...
public class TimeEntryControllerTest {
    ...
    private CounterService counterMock;
    private GaugeService gaugeMock;

    @Before
    public void setUp() throws Exception {
        timeEntryRepository = mock(TimeEntryRepository.class);
        counterMock = mock(CounterService.class);
        gaugeMock = mock(GaugeService.class);
    ...
    public void testList() throws Exception {
        List<TimeEntry> expected = asList(
            ...
            new TimeEntry(2, 789, 321, LocalDate.now().minus(1, ChronoUnit.DAYS), 4)
        );
    ...
    public void testUpdate() throws Exception {
        TimeEntry expected = new TimeEntry(1, 987, 654, LocalDate.now().minus(1, ChronoUnit.DAYS), 4);
        doReturn(expected)
            .when(timeEntryRepository)
